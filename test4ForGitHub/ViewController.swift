...
//4. Если удаленный РЕПО уже есть, то на Github идем в ветки и создаем новую ветку (указываем branch source) и клонируем на ПК или клонируем на ПК и создаем новую ветку, работаем в ней, делаем коммит и Push to remote (на Github) и там создаем пулл реквест на объединение изменений из feature1 в dev
